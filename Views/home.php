        ...
        <div class="container">
            <div class="row">
				...
				for ($j=0; $j < count($arrBanner); $j++) {
				 ...
				 ?>
                <div class="col-md-2 col-xl-2 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    ...
                    <hr>
                    <h1 style="font-size: small; text-align: center;font-size: small; text-align: center; 
                    font-weight: bold; font-family: 'Montserrat', sans-serif;"><?= $arrBanner[$j]['nombre'] ?></h1>
                </div>
                <?php 
				}
				 ?>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <a
                                href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['idproducto'].'/'.$rutaProducto; ?>">
                                <img class="product-image" src="<?= $portada ?>"
